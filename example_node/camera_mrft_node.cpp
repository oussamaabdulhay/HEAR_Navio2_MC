...
int main(int argc, char** argv) {
    ...
    ROSUnit* ros_camera_mrft_switch_x = ROSUnit_Factory_main.CreateROSUnit(ROSUnit_tx_rx_type::Client,
                                                                      ROSUnit_msg_type::ROSUnit_Float,
...
//     //*****************Flight Elements*************
    ...
    ((UpdateController*)update_controller_mrft_x)->mrft_data.num_of_peak_conf_samples=10;
    ...
    ((UpdateController*)update_controller_mrft_y)->mrft_data.id = block_id::MRFT_X;
    #endif
    ...
    ((UpdateController*)update_controller_mrft_z)->mrft_data.no_switch_delay_in_ms = 20.0;
    ...
    #ifdef MRFT_X_CAMERA
    mrft_pipeline.addElement((MissionElement*)mrft_to_pid_switch_x);
    #endif 
