...
//     //*****************Flight Elements*************
    ...
    ((UpdateController*)update_controller_camera_tracking_pid_z)->pid_data.kp = 0.6562; //0.4535
    ((UpdateController*)update_controller_camera_tracking_pid_z)->pid_data.ki = 0; 
    ((UpdateController*)update_controller_camera_tracking_pid_z)->pid_data.kd = 0.2647; //0.1829 
