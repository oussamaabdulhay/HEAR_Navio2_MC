...
//     //*****************Flight Elements*************
    ...
    ((UpdateController*)update_controller_pid_pitch)->pid_data.kp = 0.3247;
    ((UpdateController*)update_controller_pid_pitch)->pid_data.ki = 0.0;
    ((UpdateController*)update_controller_pid_pitch)->pid_data.kd =  0.0543;
    ...
    #ifdef TRANSLATION_X_CAMERA
    ((UpdateController*)update_controller_camera_hovering_pid_x)->pid_data.kp = 0.8154; //0.6552
    ((UpdateController*)update_controller_camera_hovering_pid_x)->pid_data.ki = 0.0; 
    ((UpdateController*)update_controller_camera_hovering_pid_x)->pid_data.kd = 0.4231; //0.4782
    ...
    // ((UpdateController*)update_controller_camera_tracking_pid_x)->pid_data.kp = 0.7405; //0.4878
    // ((UpdateController*)update_controller_camera_tracking_pid_x)->pid_data.ki = 0.0; 
    // ((UpdateController*)update_controller_camera_tracking_pid_x)->pid_data.kd = 0.4101; //0.3560
    ...
    // ((UpdateController*)update_controller_camera_tracking_pid_z)->pid_data.kp = 0.888; //0.4535 //0.6562
    // ((UpdateController*)update_controller_camera_tracking_pid_z)->pid_data.ki = 0; 
    // ((UpdateController*)update_controller_camera_tracking_pid_z)->pid_data.kd = 0.3258; //0.1829 //0.2647 
    ...
    // ((UpdateController*)update_controller_camera_tracking_pid_z)->pid_data.dt = (float)1.0/100.0;
