...
//     //*****************Flight Elements*************
    ...
    #ifdef TRANSLATION_X_CAMERA
    ((UpdateController*)update_controller_camera_hovering_pid_x)->pid_data.kp = 1.0846; //0.6552
    ((UpdateController*)update_controller_camera_hovering_pid_x)->pid_data.ki = 0.0; 
    ((UpdateController*)update_controller_camera_hovering_pid_x)->pid_data.kd = 0.4282; //0.4782
    ...
    #ifdef TRANSLATION_Z_CAMERA
    ((UpdateController*)update_controller_camera_hovering_pid_z)->pid_data.kp = 0.4535; //1.1766
    ((UpdateController*)update_controller_camera_hovering_pid_z)->pid_data.ki = 0; 
    ((UpdateController*)update_controller_camera_hovering_pid_z)->pid_data.kd = 0.18292; //0.3143
