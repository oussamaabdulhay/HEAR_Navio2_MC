...
//     //*****************Flight Elements*************
    ...
    #ifdef TRANSLATION_Z_CAMERA
    ((UpdateController*)update_controller_camera_hovering_pid_z)->pid_data.kp = 1.202; //1.1766
    ((UpdateController*)update_controller_camera_hovering_pid_z)->pid_data.ki = 0; 
    ((UpdateController*)update_controller_camera_hovering_pid_z)->pid_data.kd = 0.3532; //0.3143
